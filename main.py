...
# Function to get the company name from the email address
...
# Send a slack message with the qualification results

# slack_channel_hook_url = os.getenv("SLACK_CHANNEL_HOOK_TEST")
